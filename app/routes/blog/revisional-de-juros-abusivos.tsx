    ...
    <>
      ...
      >
        ...
        <p className=" text-gray mb-4 flex items-center justify-center ">
          ...
          Guilherme Batú <span className=" ml-2">{agendaIcon}</span> Dez 12,
          2022{" "}
          <span className=" ml-2">
        ...
        <p className=" mb-4 mx-auto text-[#4A5659]  leading-relaxed text-lg">
          Você esta financiando um imóvel ou um veículo e percebeu que o valor
          dos juros cobrados nas prestações são muito altos? O banco esta
          cobrando juros abusivos nas faturas atrasadas do seu cartão de
          crédito? Você sabia que é direito seu pedir revisão dos juros e,
          também, o ressarcimento por cobranças indevidas? Nesse artigo, você
          vai entender o que é a ação revisional, em quais casos ela se aplica e
          ...
          <nav>
            <ul>
              ...
              <li className=" text-brown  hover:text-gray">
                ...
                >
                  {" "}
                  2. O que são e como saber se estou sofrendo com juros
                  abusivos?
                </a>
              </li>
              <li className=" text-brown  hover:text-gray">
        ...
        <section itemProp="articleBody">
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed ">
            ...
            <strong>reverter essa situação</strong> : revisão do contrato que
            você assinou e, também, ressarcimento por cobranças indevidas.
          </p>
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            Nesse caso, se decidir recorrer à ação revisional de juros, você
            precisará de um <strong>advogado</strong>, uma vez que trata-se de
            uma
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            ...
            Entretanto, após algum tempo, você encontra dificuldade para arcar
            com o pagamento das parcelas e percebe que o valor do seu
            financiamento, com os juros, soma um total muito maior do que o
            preço à vista do seu imóvel financiado. Nesse cenário, você poderia
            recorrer a uma ação revisional de juros e verificar se os juros do
            seu contrato são <strong>abusivos</strong>.
          </p>
          <h2
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            ...
            <strong>Superior Tribunal de Justiça</strong> (STJ), os juros podem
            ser considerados abusivos quando apresentam valores muito acima da
            média do mercado:
          </p>
          <blockquote
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            ...
            consumidor. Nesse sentido, estão englobados os juros abusivos, em
            que as taxas são consideradas{" "}
            <strong>
              {" "}
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            ...
            pago ao final do financiamento e compará-lo ao valor que seria pago
            à vista. Dessa forma, você obterá o total dos juros que estão sendo
            cobrados. Para proceder a esse cálculo, existem calculadoras
            digitais, a exemplo da disponibilizada pelo Banco Central:
            <a
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            É importante ressaltar que, devido à complexidade do assunto, o
            ideal é consultar um advogado com conhecimento na área, pois ele
            será capaz de notar o que está certo e o que é abusivo no contrato.
          </p>
          <h2
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            De acordo com o Código de Defesa do Consumidor (CDC), em seu art.
            42:
          </p>
          <blockquote
            className=" italic text-justify px-28 pb-5"
          ...
          <p className=" font-semibold text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            ...
            esse juiz entender que existe um engano justificável pela
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            ...
            reduzir a prestação para o consumidor, de fmodo a cessar a cobrança
            de juros abusivos - bem <strong>acima da média do mercado</strong> -
            ou os juros sobre juros (anatocismo). Isso porque, algumas
            financeiras apresentam contratos em que o pagamento nunca ou muito
            lentamente será suficiente para reduzir o valor devido.
          </p>
          <h2
          ...
          <p className=" font-semibold text-lg mb-4 mx-auto text-[#556367]  leading-relaxed">
            Muitas vezes, os bancos e as financeiras cobram adicionais ilegais
            nas prestações. Ṕor isso, a ação revisional do cartão de crédito tem
            a finalidade de revisar os possíveis abusos cometidos nas faturas,
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            Não! de fato você não pode parar de pagar nem no momento que entra
            com a ação e nem depois, o que muda é que conseguindo a liminar você
            passa a pagar um valor reduzido em juízo. Caso contrário, o seu bem
            estará sujeito a sofrer busca e apreensão.
          </p>
          <h2
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            A liminar em média é obtida entre 15 a 45 dias, em média, a liminar
            é obtida. Ela pode ser concedida de forma parcial, completa ou
            negada.
          </p>
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
          ...
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
            Neste ínterim, enquanto aguarda o julgamento, o contratante
            depositará em juízo o valor que entende dever, usualmente a metade
            do valor atual da parcela, de modo a juntar um montante suficiente
            para fazer um acordo com a financeira.
          </p>
          <p className=" text-lg mb-4 mx-auto text-[#4A5659]  leading-relaxed">
