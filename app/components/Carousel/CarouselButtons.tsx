  ...
  >
    <svg
      ...
      className={` h-5 w-5 stroke-black  ${
        enabled ? "hover:fill-red fill-white " : "fill-black "
      } `}
    >
      <g>
...
export const NextButton = ({ enabled, onClick, thumb }: ArrowButtonProps) => (
  <button
    className={` absolute top-2/4  right-7 h-5 w-5  ${
      thumb ? "left-[101%]" : " left-[102%]"
    } `}
    onClick={onClick}
    disabled={!enabled}
  >
